              ...
              <tr key={c.id} className="border-b last:border-0 transition-colors hover:bg-indigo-50">
                ...
                <td className="px-6 py-4 text-center">
                  <div className="relative inline-block">
                    ...
                    {openMenuId === c.id && (
                      <div className="absolute right-0 top-full z-50 mt-1 w-32 rounded-lg border border-gray-100 bg-white py-1 shadow-lg">
                        <button
                          onClick={() => { setOpenMenuId(null); handleDeleteUser(c.id); }}
